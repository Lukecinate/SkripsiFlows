...
- PDF tests now load the generated bytes with PDFDocument.load and assert page count.
- This catches truncated or malformed output beyond checking the %PDF- signature.
